...
def launch():
    ...
    gridOpt = tkinter.OptionMenu(*(general, grid_var) + tuple(OPTIONS))
    ...
    precOpt = tkinter.OptionMenu(*(general, prec_var) + tuple(OPTIONS))
    ...
    precgrid_varOpt = tkinter.OptionMenu(*(general, precgrid_var) + tuple(OPTIONS))
    ...
    textOpt = tkinter.OptionMenu(*(lyrics, text_var) + tuple(OPTIONS))
